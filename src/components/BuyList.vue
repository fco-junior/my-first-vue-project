    ...
    <div class="buy-list">
        ...
        >
            <div class="confirmation-content">
                ...
                />
                <span>
                    Do you want to update the {{ productToEdit.name }}?</span
                >
            </div>
    ...
    methods: {
        ...
        updateProduct() {
            if (
                ...
                this.notification(
                    'success',
                    `${this.productToEdit.name} updated!`
                )
                this.productToEdit = {}
                this.hideUpdateProductDialog()
            }
        ...
        deleteProduct() {
            this.products.forEach((content) => {
                if (content.id === this.productToEdit.id) {
                    ...
                    this.notification(
                        'success',
                        `${this.productToEdit.name} deleted!`
                    )
        ...
        checkDuplicateNameUpdate(name) {
            ...
            this.products.forEach((content) => {
                if (
                    content.name === name &&
                    content.id !== this.productToEdit.id
                )
                    flag = true
            })
            return flag
